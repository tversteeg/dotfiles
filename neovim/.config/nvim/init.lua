		...
		config = function()
			...
			local keymaps = {
				...
				-- Custom scripts
				{
					...
					description =
					"Open or create a temporary Lua file that we can execute on a buffer with <leader><leader>l"
				},
				{
					"<leader><leader>e",
				...
				},
				{
					...
					description =
					"Append the last executed command to the temporary neovim buffer file"
				},
				...
				{ "gD",        vim.lsp.buf.implementation,                description =
				"LSP implementation" },
				{ "gr",        vim.lsp.buf.references,                    description = "LSP references" },
				{ "<c-k>",     vim.lsp.buf.signature_help,                description =
				"LSP signature help" },
				{ "<leader>d", vim.lsp.buf.type_definition,               description =
				"LSP type definition" },
				{
					"<leader>wa",
				...
				{ "<leader>r", ":IncRename ",                                         description =
				"LSP rename" },
				...
				-- Treesitter
				{ "<leader>j", helpers.lazy_required_fn("trevj", "format_at_cursor"),
					                                                                      description =
					"TS Split lines" },
